...
bool AudioOutputI2S::SetPinout()
{
    ...
    // Allow builds that do not use the optional MCLK pin by leaving it unassigned.
    // Older ESP-IDF versions need the pin number overwritten manually, so handle both cases.
